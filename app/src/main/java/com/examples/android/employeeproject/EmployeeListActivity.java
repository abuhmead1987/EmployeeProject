...
import com.examples.android.employeeproject.adapters.EmployeesAdapter;
...
public class EmployeeListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new EmployeesAdapter(this, MainActivity.employeeLinkedList, mTwoPane));
    }
